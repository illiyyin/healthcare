        ...
        <div className="lg:flex flex-grow items-center bg-black lg:bg-opacity-0 lg:shadow-none hidden bg-blueGray-800" id="example-collapse-navbar">
          <ul className="flex flex-col lg:flex-row list-none mr-auto">
            <li className="flex items-center">
              <a className="text-gray-700 lg:hover:text-blueGray-200  px-3 py-4 lg:py-2 flex items-center text-base  " href="#"><i className="lg:text-blueGray-200 text-blueGray-400 far fa-file-alt text-lg leading-lg mr-2"></i>
                About</a>
            </li>
          ...
          <ul className="flex flex-col lg:flex-row list-none lg:ml-auto items-center">
            ...
            <li className="flex items-center">
              ...
              <a href="" className="bg-yellow-500 rounded-full font-bold text-white px-6 py-3 transition duration-300 ease-in-out hover:bg-yellow-600 mr-6">
                Appointment
              </a>
